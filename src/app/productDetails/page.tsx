...
const ProductDetails = ({ onBack }: { onBack: () => void }) => {
  return (
      ...
      <div className="w-full max-w-7xl border-x-2 border-black min-h-screen flex flex-col bg-white">
        ...
        <header className="flex justify-between items-stretch border-b-2 border-black h-20">
          ...
          <div className="flex-1 flex items-center justify-between px-8">
            {/* Back Button */}
            <button onClick={onBack} className="font-mono font-bold text-sm underline hover:text-gray-600">
              ← Back to Market
            </button>

            <div className="flex gap-8 items-center">
              <span className="font-mono font-bold hidden md:block">How it works</span>
          ...
          <div className="flex-1 flex flex-col gap-12">
            ...
            <div className="w-full border-2 border-black bg-gray-50 relative overflow-hidden flex flex-col md:flex-row p-6 gap-6">
              ...
              <div className="flex-1 z-10 flex flex-col justify-between">
                <div>
                  <h1 className="text-4xl font-black uppercase leading-none">NAME</h1>
                  <h2 className="text-xl font-black text-gray-500 uppercase">SUBNAME</h2>
            ...
            <div className="w-full border-2 border-black bg-white p-6 h-[500px] flex flex-col shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              <div className="mb-4">
                ...
                <h3 className="text-4xl font-black uppercase">$5.9K</h3>
                <p className="font-mono text-xs text-green-600 font-bold mt-1">+$313 (+5.65%) 24hr</p>
              </div>
